...
class Tool:
    ...
    # Auto-generated from function signature (never manually set)
    # Generated by create_tool_schema() which filters runtime-injected params
...
def tool(
    ...
    *,
    ...
    Parameter schemas are automatically generated from function signatures.
    """
    def decorator(func: Callable) -> Callable:
        ...
        # Attach metadata - parameters_schema will be auto-generated from signature
        func.__laddr_tool__ = Tool(
            name=tool_name,
            func=func,
            description=tool_description,
            input_model=input_model,
            parameters_schema=None,  # Always None - auto-generated from signature
...
def create_tool_schema(tool: Tool) -> dict[str, Any]:
    ...
    if tool.input_model and BaseModel and issubclass(tool.input_model, BaseModel):
        ...
        # Handle bound methods (system tools)
        if hasattr(tool.func, '__self__'):
            # It's a bound method, get the unbound method
            try:
                unbound = getattr(tool.func.__self__.__class__, tool.func.__name__)
                sig = inspect.signature(unbound)
            except (AttributeError, TypeError):
                # If we can't get unbound method, use bound method signature
                pass
        
        for param_name, param in sig.parameters.items():
            # FILTER runtime-injected parameters
            ...
            param_desc = _extract_param_description(tool.func, param_name)
            if param_desc:
            ...
            if param.default == inspect.Parameter.empty:
                ...
                # Include default value in schema
                try:
                    ...
                    # Skip non-serializable defaults (like None for Optional types)
                    pass
